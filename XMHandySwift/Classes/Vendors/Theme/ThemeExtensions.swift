...
extension UIView {
    static let swizzleAddSubview: Void = {
        XMHandySwift.swizzleMethod(UIView.self, originalSelector: #selector(addSubview(_:)), swizzledSelector: #selector(swizzledAddSubview(_:)))
    }()
...
extension CALayer {
    static let swizzleAddSublayer: Void = {
        XMHandySwift.swizzleMethod(CALayer.self, originalSelector: #selector(addSublayer(_:)), swizzledSelector: #selector(swizzledAddSublayer(_:)))
    }()

...
fileprivate var TSAssociatedClosure: UInt8 = 23
...
public extension UIView {
    ...
    func tapped(callback: @escaping () -> Void) -> UITapGestureRecognizer {
        ...
        objc_setAssociatedObject(self, &TSAssociatedClosure, wrapper, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        return gesture
    }

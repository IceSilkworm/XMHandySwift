...
extension UIColor{
    public class func RGB(r: CGFloat, g: CGFloat, b: CGFloat, a: CGFloat? = nil) -> UIColor {
        let color = UIColor.init(red: r / 255.0, green: g / 255.0, blue: b / 255.0, alpha: a ?? 1.0)
        return color
    }
...
extension UIColor {
    ...
    public func asImage(_ size: CGSize = CGSize(width: 50.0, height: 50.0)) -> UIImage? {
